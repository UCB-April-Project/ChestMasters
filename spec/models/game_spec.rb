...
RSpec.describe Game, type: :model do 
    ...
    describe "populate_game function" do
      it "should create 32 chess_pieces" do
        game = FactoryBot.create(:game)
        expect(game.chess_pieces.count).to eq 32
      end
  
      it "should create the correct number of each piece type" do
        game = FactoryBot.create(:game)
      ...
      it "should create 16 pieces on each team" do
        game = FactoryBot.create(:game)
